...
public static class ColorConsole {
    ...
    static readonly ConsoleColor[] _fishColors = new[] {
        ConsoleColor.Cyan,
    ...
    public static ConsoleColor GetRandomColor()
        => _fishColors[_random.Next( _fishColors.Length )];
    ...
    public static string[] ApplyRandomColors(string[] colorMask) {
        ...
        Dictionary<char, char> colorMap = new();
        ...
        for (var i = 0; i < colorMask.Length; i++) {
            string line = colorMask[i];
    ...
    /// </summary>
    static char GetRandomColorChar() {
